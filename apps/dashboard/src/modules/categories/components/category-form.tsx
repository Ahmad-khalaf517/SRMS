...
import { CreateCategorySchema, type CreateCategoryDTO } from '@srms/api-contracts/categories';
...
export function categoryToFormValues(category: Category): Partial<CreateCategoryDTO> {
