...
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@srms/ui/components/tabs';
...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  {
    ...
    header: 'Header',
    cell: ({ row }) => {
      return <div className="w-fit px-0 text-left text-foreground">{row.original.header}</div>;
    },
    enableHiding: false,
  },
  {
